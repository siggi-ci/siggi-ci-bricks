...
public interface GhcomMappings {
    ...
    static String UI_PROVIDER = "/ui/providers/ghcom";
    ...
    static String REPOSITORY_DISABLE = UI_PROVIDER + "/repo/disable";
    static String REPOSITORY_ENABLE = UI_PROVIDER + "/repo/enable";
