...
public class GheAuthenticationService extends OAuth2AuthenticationService<Ghe> {
	...
	public GheAuthenticationService(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl, String apiBaseUrl) {
		super(new GheConnectionFactory(clientId, clientSecret, authorizeUrl, accessTokenUrl, apiBaseUrl));
	}
}
