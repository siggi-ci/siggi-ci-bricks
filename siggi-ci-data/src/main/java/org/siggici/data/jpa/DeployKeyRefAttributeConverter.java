...
/**
 * Converts the {@link DeployKeyRef} from and to an {@link String} during
...
public class DeployKeyRefAttributeConverter implements AttributeConverter<DeployKeyRef, String> {
    ...
    @Override
    public DeployKeyRef convertToEntityAttribute(String dbData) {
        return DeployKeyRef.builder().deployKeyReference(dbData).build();
    }
